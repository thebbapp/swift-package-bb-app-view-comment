...
let package = Package(
    name: "BbAppViewComment",
    defaultLocalization: "en",
    platforms: [.iOS("18.5"), .macOS("15.5"), .tvOS("18.0")],
    products: [.library(name: "BbAppViewComment", targets: ["BbAppViewComment"])],
    dependencies: [
    ...
    targets: [
        .binaryTarget(
            name: "BbAppViewComment",
            url:
                "https://github.com/thebbapp/swift-package-bb-app-view-comment/releases/download/v0.1.0/BbAppViewComment.xcframework.zip",
            checksum: "edcef4888eae2d89109d65663de3d4f27587cde2b5a0b6e972b81a32eb4ea327"
        )
    ],
